...
- Portable API is in place (`ios/include/zomdroid_core_api.h`).
...
- Bridge implemented: `ios/Sources/ZomdroidIOSBridge.mm`.
- UIKit app shell implemented: `ios/App/ZomdroidGameViewController.mm`.
