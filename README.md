...
## iOS Port (JIT/Jailbreak)

A jailbreak/JIT-oriented iOS port path is available in the `ios/` folder:

- `ios/README.md`
- `ios/PORTING.md`

It includes:
- native iOS bridge APIs
- a UIKit app shell target
- launch config format for runtime startup
- optional emulation backend wiring for box64/JIT builds
