...
#define LOGF(fmt, ...) _LOG_STDERR("F", "[%s] " fmt, __func__ __VA_OPT__(, ) __VA_ARGS__)
#define LOGE(fmt, ...) _LOG_STDERR("E", "[%s] " fmt, __func__ __VA_OPT__(, ) __VA_ARGS__)
#define LOGW(fmt, ...) _LOG_STDERR("W", (fmt)__VA_OPT__(, ) __VA_ARGS__)
#define LOGI(fmt, ...) _LOG_STDERR("I", (fmt)__VA_OPT__(, ) __VA_ARGS__)
#define LOGD(fmt, ...) _LOG_STDERR("D", (fmt)__VA_OPT__(, ) __VA_ARGS__)
#define LOGV(fmt, ...) _LOG_STDERR("V", (fmt)__VA_OPT__(, ) __VA_ARGS__)
#endif
